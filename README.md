...
![Screenshot full code editor page](https://github.com/MaximeCaty/AL-Interpreter/blob/main/AL-Interpreter/Images/Screenshot-Sample.png?raw=true)
...
<img src="https://github.com/MaximeCaty/AL-Interpreter/blob/main/AL-Interpreter/Images/Screenshot-AutoCompletion.png" alt="Screenshot-AutoCompletion" width="50%"/>
...
![Screenshot syntax error](https://github.com/MaximeCaty/AL-Interpreter/blob/main/AL-Interpreter/Images/Screenshot-Syntax-Error.png?raw=true)
...
<img src="https://github.com/MaximeCaty/AL-Interpreter/blob/main/AL-Interpreter/Images/Screenshot-MultiTabs.png?raw=true" alt="Screenshot multi tab" width="50%"/>

### Compile & run options

<!-- SCREENSHOT 5: the Options page (Compiler Options + Execution Options groups). -->
<img src="https://github.com/MaximeCaty/AL-Interpreter/blob/main/AL-Interpreter/Images/Screenshot-Compile-Options-dropdown.png?raw=true" alt="Screenshot-Compile-Options-dropdown" width="200"/>
<img src="https://github.com/MaximeCaty/AL-Interpreter/blob/main/AL-Interpreter/Images/Screenshot-Compile-Options.png?raw=true" alt="Screenshot-Compile-Options" width="75%"/>
